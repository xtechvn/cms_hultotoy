...
namespace Repositories.Repositories
{
    public class SupplierRepository : BaseRepository, ISupplierRepository
    {
        ...
        public IEnumerable<SupplierRoomGridModel> GetRoomListOfSupplier(long supplier_id,string ServiceName, int page_index = 1, int page_size = 10)
        {
            try
            {
                var data = supplierDAL.GetRoomBySupplierId(supplier_id, ServiceName, page_index, page_size);
