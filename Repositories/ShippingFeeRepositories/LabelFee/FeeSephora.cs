...
namespace Repositories.ShippingFeeRepositories.LabelFee
{
    ...
    /// </summary>
    class FeeSephora : BaseJomashopShippingFee
    {
        //Inject đầu vào
        public FeeSephora(ProductBuyerViewModel ProductBuyer, List<PriceLevelViewModel> PriceLevelLabel, List<IndustrySpecialViewModel> IndustrySpecial)
        ...
        public Dictionary<string, double> getSephoraShippingFee()
        {
            try
            {
            ...
            {
                LogHelper.InsertLogTelegram("getSephoraShippingFee" + ex.Message);
                return null;
