...
namespace Repositories.ShippingFeeRepositories.LabelFee
{
    ...
    /// </summary>
    class FeeHautelook : BaseJomashopShippingFee // Chung cach tinh voi JOMA
    {
        //Inject đầu vào
        public FeeHautelook(ProductBuyerViewModel ProductBuyer, List<PriceLevelViewModel> PriceLevelLabel, List<IndustrySpecialViewModel> IndustrySpecial)
        ...
        public Dictionary<string, double> getHautelookShippingFee()
        {
            try
            {
            ...
            {
                LogHelper.InsertLogTelegram("getHautelookShippingFee" + ex.Message);
                return null;
