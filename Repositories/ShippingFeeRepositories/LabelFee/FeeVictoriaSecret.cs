...
namespace Repositories.ShippingFeeRepositories.LabelFee
{
    ...
    /// </summary>
    class FeeVictoriaSecret : BaseJomashopShippingFee
    {
        //Inject đầu vào
        public FeeVictoriaSecret(ProductBuyerViewModel ProductBuyer, List<PriceLevelViewModel> PriceLevelLabel, List<IndustrySpecialViewModel> IndustrySpecial)
        ...
        public Dictionary<string, double> getVictoriaSecretShippingFee()
        {
            try
            {
            ...
            {
                LogHelper.InsertLogTelegram("getVictoriaSecretShippingFee" + ex.Message);
                return null;
