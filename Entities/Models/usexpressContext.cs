...
{
    public partial class usexpressContext : DbContext
    {
        public usexpressContext()
        {
        }

        public usexpressContext(DbContextOptions<usexpressContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=103.74.121.131;Initial Catalog=usexpress;Persist Security Info=True;User ID=usex;Password=us@585668");
            }
        }
