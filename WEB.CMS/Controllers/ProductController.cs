...
namespace WEB.CMS.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        private async Task SyncMongoDB()
        {
            try
            {
                // ProductESRepository<object> _ProductESRepository = new ProductESRepository<object>(_Configuration["DataBaseConfig:Elastic:Host"]);
                /*
                ...
                ProductESRepository<object> _ProductESRepository = new ProductESRepository<object>(_Configuration["DataBaseConfig:Elastic:Host"]);
                 var list = _ProductESRepository.GetListProductManual();
                 if (list != null && list.Count > 0)
